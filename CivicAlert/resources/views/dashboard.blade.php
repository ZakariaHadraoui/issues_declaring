 ...
 <div id="wrapper">
    ...
    {{-- <!--Start sidebar-wrapper-->
     ...
     <ul class="sidebar-menu do-nicescrol">
        ...
        <li>
          <a href="/categories">
            <i class="zmdi zmdi-view-dashboard"></i> <span>All Categories</span>
          </a>
        </li>
  
        <li>
          <a href="/categories/create">
            <i class="zmdi zmdi-invert-colors"></i> <span>Create Category</span>
          </a>
        </li>
  ...
  <div style="width: 50vw" class=" content-wrapper">
    <div class="container-fluid">

  <!--Start Dashboard Content-->

	<div style="width: 80vw" class="card mt-3">
