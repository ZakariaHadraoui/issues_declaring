...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
	<div class="container">
		<div class="text-center mx-auto mb-5" style="max-width: 600px;">
			<h5 class="text-primary text-uppercase" style="letter-spacing: 5px;">Poser Déclaration</h5>
			<h1 class="display-5 mb-0">Signalement Urbain Rapide</h1>
		</div>
		<div class="row g-5">
				...
				<div class="bg-light rounded p-5">
					<form>
						<div class="row g-3">
							...
							<div class="col-12">
								<button class="btn btn-primary w-100 py-3" type="submit">Confirmer déclaration</button>
							</div>
						</div>
					</form>
				</div>
